export const enrollmentEn = {
  ...
  addons: {
    ...
    "rmv-area-3-rmv-branch": {
      ...
      description:
        "Road Test at Branch RMV Weekdays only. Branches: Haverhill, Lawrence, Lowell, Milford, Wilmington, Worcester. The road test fee is non-refundable.",
    },
    "comp-test-watertown": {
...
export const enrollmentEs: EnrollmentMessages = {
  ...
  addons: {
    ...
    "rmv-area-3-rmv-branch": {
      ...
      description:
        "Examen práctico en sucursal RMV solo entre semana. Sucursales: Haverhill, Lawrence, Lowell, Milford, Wilmington, Worcester. La tarifa del examen práctico no es reembolsable.",
    },
    "comp-test-watertown": {
...
export const enrollmentPt: EnrollmentMessages = {
  ...
  addons: {
    ...
    "rmv-area-3-rmv-branch": {
      ...
      description:
        "Teste prático em filial RMV apenas em dias úteis. Filiais: Haverhill, Lawrence, Lowell, Milford, Wilmington, Worcester. A taxa do teste prático não é reembolsável.",
    },
    "comp-test-watertown": {
...
export const enrollmentHt: EnrollmentMessages = {
  ...
  addons: {
    ...
    "rmv-area-3-rmv-branch": {
      ...
      description:
        "Tès wout nan branch RMV jou ouvrab sèlman. Branch yo: Haverhill, Lawrence, Lowell, Milford, Wilmington, Worcester. Frè tès wout la pa ranbousab.",
    },
    "comp-test-watertown": {
